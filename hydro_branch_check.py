...
agreement between the two is a genuine cross-check rather than a re-run:
  ...
  * Dimensionless formulation. The structure system (paper Eq. 32) is reduced to a
...
print(f"log10 M_crit = {np.log10(Ms[imax]):.3f}  (paper: 6.21)")
...
print(f"  predicted median log M = {med:.4f}  (paper: 6.10 [6.096])")
