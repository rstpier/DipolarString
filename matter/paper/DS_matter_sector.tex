...
statement imposes and what it breaks; the record is 107 steps (R1--R107) backed by 102 scripts.
...
is inert (no $-1$), a spinor with the $-1$ goes at $2c_0/3$. The field reading survives as a
consistent reading of the electron; its carrier is not the weave of V2.10.

\status{Conditionally derived for the field identities of R104 (on the spinor nature of the
unit); Derived for the group-theoretic velocities $1/3$ and $1/2$; Closed for the electron field
as an excitation of the cubic weave}
...
of the cubic weave ($v_e/c_0 = 2/3$); a weak sector inside the base; dark matter from the medium;
...
at $2c_0/3$ (R106--R107). What is needed is a medium whose node gives the spinor and the photon the
same limiting velocity, or an electron field that is not a weave excitation (the $n \ge 3$ bundles
of the earlier phase are the only other carriers the base has). Until then the base derives none
of $S$, $\mu_B$, $g$.
...
in the session record and is to be filled in by the author) wrote the 102 scripts, ran them,
