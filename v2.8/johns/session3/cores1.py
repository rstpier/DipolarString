import numpy as np, scipy.sparse.linalg as spl, sys
from track import buildU, core_mask
Nx=11; kz=2.0; c=Nx//2
geoms={
 "ref L (0,0)(1,0)(0,1)": [(c,c),(c+1,c),(c,c+1)],
 "L miroir (0,0)(1,0)(1,1)": [(c,c),(c+1,c),(c+1,c+1)],
 "ordre inverse (0,0)(0,1)(1,0)": [(c,c),(c,c+1),(c+1,c)],
}
